...
raws_list={"building_dragon_engine.txt","building_web_thrower.txt","reaction_add_webs.txt","building_wall_mover.txt"}
patch_entity=[[
...
patch_dofile={"mechanicalWorkshops.lua","wall_mover.lua"}
author="warmist"
description=[[
