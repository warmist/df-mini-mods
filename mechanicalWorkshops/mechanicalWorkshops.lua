...
local dragon_engine_dirs={
	S={gear={x=0,y=2},spew={x=0,y=3,dx=0,dy=1,mx=0,my=0}}, --spew place, direction, magma place
	N={gear={x=0,y=1},spew={x=0,y=0,dx=0,dy=-1,mx=0,my=3}},
	W={gear={x=1,y=0},spew={x=0,y=0,dx=-1,dy=0,mx=3,my=0}},
	E={gear={x=2,y=0},spew={x=3,y=0,dx=1,dy=0,mx=0,my=0}},
	}
